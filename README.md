...
NOTE: There are a few dummy accounts to log in with
-> username: johnd    password: password123
-> username: bwanafy  password: pass1
-> username: rocketgal    password: pass2

You can also make your own accounts with the sign in feature.
